...
OPEN_JTALK_DICT_DIR = os.environ.get(
    "OPEN_JTALK_DICT_DIR",
    pkg_resources.resource_filename(__name__, "open_jtalk_dic_utf_8-1.11_rare_syllebles"),
).encode("utf-8")
_dict_download_url = "https://github.com/korguchi/open_jtalk/releases/download/v1.11.2.1/"
_DICT_URL = f"{_dict_download_url}/open_jtalk_dic_utf_8-1.11_rare_syllebles.tar.gz"
